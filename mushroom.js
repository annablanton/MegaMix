class Mushroom {
    ...
    draw(ctx) {
        if (this.type == 0) {
            ctx.drawImage(this.spritesheet, 0, 0, 227, 227, this.x, this.y, this.SPRITE_WIDTH, this.SPRITE_HEIGHT);
        } else {
            ctx.drawImage(this.spritesheet, 228, 0, 227, 227, this.x, this.y, this.SPRITE_WIDTH, this.SPRITE_HEIGHT);
        }
        if (PARAMS.DEBUG) {
